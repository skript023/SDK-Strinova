...
public:
	...
	static class Projectile_E_KokonaShiki::AProjectile_E_KokonaShiki_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<Projectile_E_KokonaShiki::AProjectile_E_KokonaShiki_C>();
	}
};
DUMPER7_ASSERTS_Projectile_E_KokonaShiki__AProjectile_E_KokonaShiki_C;
