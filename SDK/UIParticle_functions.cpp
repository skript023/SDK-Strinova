...
int32 UUIParticleUtility::GetLOD()
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("UIParticleUtility", "GetLOD");

	Params::UIParticleUtility_GetLOD Parms{};
...
bool UUIParticleUtility::GetMultiThread()
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("UIParticleUtility", "GetMultiThread");

	Params::UIParticleUtility_GetMultiThread Parms{};
...
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// int32                                   newlod                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UUIParticleUtility::SetLOD(int32 newlod)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("UIParticleUtility", "SetLOD");

	Params::UIParticleUtility_SetLOD Parms{};
...
void UUIParticleUtility::SetMultiThread(bool Value)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("UIParticleUtility", "SetMultiThread");

	Params::UIParticleUtility_SetMultiThread Parms{};
