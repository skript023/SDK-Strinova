...
public:
	...
	static class GE_ArousalOne_MoBai_0::UGE_ArousalOne_MoBai_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<GE_ArousalOne_MoBai_0::UGE_ArousalOne_MoBai_C>();
	}
};
DUMPER7_ASSERTS_GE_ArousalOne_MoBai_0__UGE_ArousalOne_MoBai_C;
