...
public:
	...
	static class Projectile_Q_Lawine::AProjectile_Q_Lawine_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<Projectile_Q_Lawine::AProjectile_Q_Lawine_C>();
	}
};
DUMPER7_ASSERTS_Projectile_Q_Lawine__AProjectile_Q_Lawine_C;
