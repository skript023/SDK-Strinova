...
public:
	...
	static class Weapon_Q_Maddelena::AWeapon_Q_Maddelena_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<Weapon_Q_Maddelena::AWeapon_Q_Maddelena_C>();
	}
};
DUMPER7_ASSERTS_Weapon_Q_Maddelena__AWeapon_Q_Maddelena_C;
