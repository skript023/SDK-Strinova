...
class Weapon_Q_Yvette::AWeapon_Q_Yvette_C final : public ACyWeaponQuickThrow
{
public:
...
public:
	...
	static class Weapon_Q_Yvette::AWeapon_Q_Yvette_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<Weapon_Q_Yvette::AWeapon_Q_Yvette_C>();
	}
};
DUMPER7_ASSERTS_Weapon_Q_Yvette__AWeapon_Q_Yvette_C;
