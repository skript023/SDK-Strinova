...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_PickupEffect_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_PickupEffect_C")
	}
	static class ABP_PickupEffect_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_PickupEffect_C>();
	}
};
DUMPER7_ASSERTS_ABP_PickupEffect_C;
