...
public:
	...
	static class Weapon_E_Aika_0::AWeapon_E_Aika_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<Weapon_E_Aika_0::AWeapon_E_Aika_C>();
	}
};
DUMPER7_ASSERTS_Weapon_E_Aika_0__AWeapon_E_Aika_C;
