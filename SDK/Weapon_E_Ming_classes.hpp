...
class Weapon_E_Ming::AWeapon_E_Ming_C final : public ACyWeaponTriggerThrow
{
public:
...
public:
	...
	static class Weapon_E_Ming::AWeapon_E_Ming_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<Weapon_E_Ming::AWeapon_E_Ming_C>();
	}
};
DUMPER7_ASSERTS_Weapon_E_Ming__AWeapon_E_Ming_C;
